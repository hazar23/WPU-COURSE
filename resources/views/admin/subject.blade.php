    ...
    <div class="row">
        <div class="col-lg-12 white-bg">
            ...
            <div class="pull-right p-1">
                <button data-toggle="modal" data-target="#insert_subject" type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Matakuliah </button>                
            </div>            
            <div class="clearfix"></div><br>
            <div class="table-responsive">
                <table width="100%" class="table table-striped table-bordered table-hover dataTables-example dataTable" id="table_subject">
                    <thead>
                    <tr>
...
{{-- modal tambah course --}}
<div class="modal fade" id="insert_subject" tabindex="-1" role="dialog" aria-labelledby="modalsubject">
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                ...
                <form id="form_insert_subject" method="POST" action="#">
                        ...
                        <div class="form_insert">                                                                                                                            
                            ...
                            <div class="form-group">
                                    <label for="ins_title" >Nama</label>
                                        <input type="text" placeholder="nama subject" class="form-control" id="ins_title" name="title"/>
                                            <span class="text-danger">
    ...
    {{-- update course --}}
    <div class="modal fade" id="update_subject" tabindex="-1" role="dialog" aria-labelledby="modalbarang">
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                <div class="modal-header">
                ...
                <form id="form_update_subject" method="POST" action="#">                    
                    <div class="modal-body">
        ...
        $(document).ready(function () {
            var styles = {
                button: function (row, type, data) {
                    return `<center>` + `<a href="#" data-toggle="modal" data-target="#update_subject" class="btn btn-success btn-circle btn-edit" id="${data.id}"><i class="fa fa-pencil-alt"></i></a>
            ...
            //fungsi tambah
            $("#form_insert_subject").submit(function (e) {                
                e.preventDefault();                           
