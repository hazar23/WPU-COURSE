...
class PathController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $update = Path::findOrFail($id)->update($data);
    ...
    public function destroy(Request $request)
    {
        ...
        $delete = Path::findOrFail($id)->delete();
