    ...
    <div class="row">
        <div class="col-lg-12 white-bg">
            ...
            <div class="pull-right p-1">
                <button data-toggle="modal" data-target="#insert_level" type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Level </button>                
            </div>            
            <div class="clearfix"></div><br>
            <div class="table-responsive">
                <table width="100%" class="table table-striped table-bordered table-hover dataTables-example dataTable" id="table_level">
                    <thead>
                    <tr>
...
<div class="modal fade" id="insert_level" tabindex="-1" role="dialog" aria-labelledby="modallevel">
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                ...
                <form id="form_insert_level" method="POST" action="#">
                        ...
                        <div class="form_insert">                                                                                                                            
                            ...
                            <div class="form-group">
                                    <label for="ins_title" >Nama</label>
                                        <input type="text" placeholder="nama level" class="form-control" id="ins_title" name="title"/>
                                            <span class="text-danger">
    ...
    <div class="modal fade" id="update_level" tabindex="-1" role="dialog" aria-labelledby="modalbarang">
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span
                                aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title-update">Update Level</h4>
                </div>
                <form id="form_update_level" method="POST" action="#">                    
                    <div class="modal-body">
        ...
        $(document).ready(function () {
            var styles = {
                button: function (row, type, data) {
                    return `<center>` + `<a href="#" data-toggle="modal" data-target="#update_level" class="btn btn-success btn-circle btn-edit" id="${data.id}"><i class="fa fa-pencil-alt"></i></a>
            ...
            table = $('#table_level').DataTable({
                ...
                ajax: {
                    "url": '<?php echo e(URL('level/dataTable')); ?>',
                    "headers": {
            ...
            //fungsi tambah
            $("#form_insert_level").submit(function (e) {                
                e.preventDefault();                           
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(URL('level/insert')); ?>",
                    type: "POST",
            ...
            //fungsi ubah data
            $("#form_update_level").submit(function (e) {
                e.preventDefault();                
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(URL('level/update')); ?>",
                    type: "POST",
                    data: new FormData(this),
                    processData:false,
                    contentType:false,
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            ...
                            url: '<?php echo e(URL('level/delete')); ?>',
                            type: 'DELETE',
                            data: "id=" + id,
                            dataType: 'json',
