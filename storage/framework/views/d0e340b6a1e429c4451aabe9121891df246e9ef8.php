    ...
    <div class="row">
        <div class="col-lg-12 white-bg">
            ...
            <div class="pull-right p-1">
                <button data-toggle="modal" data-target="#insert_matakuliah" type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Matakuliah </button>                
            </div>            
            <div class="clearfix"></div><br>
            <div class="table-responsive">
                <table width="100%" class="table table-striped table-bordered table-hover dataTables-example dataTable" id="table_matakuliah">
                    <thead>
                    <tr>
...
<div class="modal fade" id="insert_matakuliah" tabindex="-1" role="dialog" aria-labelledby="modalmatakuliah">
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                ...
                <form id="form_insert_matakuliah" method="POST" action="#">
                        ...
                        <div class="form_insert">                                                                                                                            
                            ...
                            <div class="form-group">
                                    <label for="ins_title" >Nama</label>
                                        <input type="text" placeholder="nama matakuliah" class="form-control" id="ins_title" name="title"/>
                                            <span class="text-danger">
    ...
    <div class="modal fade" id="update_matakuliah" tabindex="-1" role="dialog" aria-labelledby="modalbarang">
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span
                                aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title-update">Update Matakuliah</h4>
                </div>
                <form id="form_update_matakuliah" method="POST" action="#">                    
                    <div class="modal-body">
        ...
        $(document).ready(function () {
            var styles = {
                button: function (row, type, data) {
                    return `<center>` + `<a href="#" data-toggle="modal" data-target="#update_matakuliah" class="btn btn-success btn-circle btn-edit" id="${data.id}"><i class="fa fa-pencil-alt"></i></a>
            ...
            // form tambah
            $( "#form_insert_matakuliah" ).validate({
                rules: {                    
                    image: {
                    required: true,
                    accept: "image/*"                    
             ...
             // form update
             $( "#form_update_matakuliah" ).validate({
                rules: {                    
                    title: {
                    required: true
                    }                    
            ...
            //datatables
            table = $('#table_matakuliah').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                order: [[1, 'desc']],
            ...
            //fungsi tambah
            $("#form_insert_matakuliah").submit(function (e) {                
                e.preventDefault();                           
            ...
            //fungsi ubah data
            $("#form_update_matakuliah").submit(function (e) {
                e.preventDefault();                
