    ...
    <script>
        $(document).ready(function () {            
            ...
            table = $('#table_lesson').DataTable({
                ...
                ajax: {
                    "url": '<?php echo e(URL('lesson/dataTable')); ?>',
                    "headers": {
            ...
            $("#form_insert_lesson").submit(function (e) {                
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(URL('lesson/insert')); ?>",
                    type: "POST",
            ...
            table.on('click', '.btn-edit', function (e) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(URL('lesson/edit')); ?>",
                    type: "GET",
                    data: 'id=' + id,
                    dataType: "JSON",
                    success: function (data) {
            ...
            $("#form_update_lesson").submit(function (e) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(URL('lesson/update')); ?>",
                    type: "POST",
                    data: new FormData(this),
                    processData:false,
                    contentType:false,
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            ...
                            url: '<?php echo e(URL('lesson/delete')); ?>',
                            type: 'DELETE',
                            data: "id=" + id,
                            dataType: 'json',
