    ...
    <div class="row">
        <div class="col-lg-12 white-bg">
            ...
            <div class="pull-right p-1">
                <button data-toggle="modal" data-target="#insert_jalur" type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Jalur </button>                
            </div>            
            <div class="clearfix"></div><br>
            <div class="table-responsive">
                <table width="100%" class="table table-striped table-bordered table-hover dataTables-example dataTable" id="table_jalur">
                    <thead>
                    <tr>
...
<div class="modal fade" id="insert_jalur" tabindex="-1" role="dialog" aria-labelledby="modaljalur">
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                ...
                <form id="form_insert_jalur" method="POST" action="#">
                        ...
                        <div class="form_insert">                                                                                                                            
                            ...
                            <div class="form-group">
                                    <label for="ins_title" >Nama</label>
                                        <input type="text" placeholder="nama jalur" class="form-control" id="ins_title" name="title"/>
                                            <span class="text-danger">
    ...
    <div class="modal fade" id="update_jalur" tabindex="-1" role="dialog" aria-labelledby="modaljalur">
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                <div class="modal-header">
                ...
                <form id="form_update_jalur" method="POST" action="#">                    
                    <div class="modal-body">
        ...
        $(document).ready(function () {
            var styles = {
                button: function (row, type, data) {
                    return `<center>` + `<a href="#" data-toggle="modal" data-target="#update_jalur" class="btn btn-success btn-circle btn-edit" id="${data.id}"><i class="fa fa-pencil-alt"></i></a>
            ...
            //fungsi tambah
            $("#form_insert_jalur").submit(function (e) {                
                e.preventDefault();                           
            ...
            //fungsi ubah data
            $("#form_update_jalur").submit(function (e) {
                e.preventDefault();                
