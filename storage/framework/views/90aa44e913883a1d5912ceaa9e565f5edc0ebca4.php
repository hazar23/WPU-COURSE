    ...
    <script>
        $(document).ready(function () {
            ...
            table = $('#table_path').DataTable({
                ...
                ajax: {
                    "url": '<?php echo e(URL('path/dataTable')); ?>',
                    "headers": {
            ...
            $("#form_insert_path").submit(function (e) {                
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(URL('path/insert')); ?>",
                    type: "POST",
            ...
            $("#form_update_path").submit(function (e) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(URL('path/update')); ?>",
                    type: "POST",
                    data: new FormData(this),
                    processData:false,
                    contentType:false,
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            ...
                            url: '<?php echo e(URL('path/delete')); ?>',
                            type: 'DELETE',
                            data: "id=" + id,
                            dataType: 'json',
