                        ...
                        <div class="ibox">
                            <div class="ibox-content product-box">                                        
                                <div class="product-imitation">
                                    <img src="images/<?php echo e($ter->image); ?>" alt="" width="255px;" height="150px;">
                                </div>                                
                                ...
                                <b><h3 class="product-name"><?php echo e($ter->title); ?></h3></b>
                                    ...
                                    <span class="badge badge-primary" style="padding:5px; margin:7px 0px 7px 0px;">Laravel </span>                                 
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6">
                                                    <span class="badge waktu" style="padding:5px; margin-left:-10px;"><i class="fas fa-clock"></i></i> <?php echo e(\Carbon\Carbon::parse($ter->created_at)->diffForHumans()); ?> </span>
                                            </div>
                                        </div>                                                                       
                                </div>
                            </div>
